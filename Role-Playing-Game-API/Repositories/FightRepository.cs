...
public class FightRepository : IFightRepository
{
    ...
    public async Task<ApiResponse<FightResultDto>> Fight(FightRequestDto request)
    {
        var response = new ApiResponse<FightResultDto>
        {
    ...
    public async Task<ApiResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
    {
        var response = new ApiResponse<AttackResultDto>();
        try
        {
    ...
    public async Task<ApiResponse<AttackResultDto>> WeaponAttack(WeaponAttackDto request)
    {
        var response = new ApiResponse<AttackResultDto>();
        try
        {
    ...
    public async Task<ApiResponse<List<HighscoreDto>>> GetHighscore()
    {
        var characters = await _context.Characters
            .Where(c => c.Fights > 0)
        ...
        var response = new ApiResponse<List<HighscoreDto>>()
        {
